class EventsController < ApplicationController
  ...
  # GET /events.json
    ...
    def join
        ...
        respond_to do |format|
            format.html { redirect_to @event, notice: 'We will notify you'}
        end
    end
  ...
  def show
    ...
    # @event_owner = @events.event_owner(@event.organizer_id)
  ...
  private
    ...
    def event_owner!
        ...
        if @event.organizer_id != current_user.id
            ...
            flash[:notice] = 'You do not have permissions to do this'
        end
    end
end
